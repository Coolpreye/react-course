...
function About(props) {
    ...
    const RenderLeaders = props.leaders.map((leader) => {
        return (
            <Media key={leader.id} tag="li" className="row mt-5">
                  <Media className="col-12 col-md-2" left middle>
                      <Media object src={leader.image} alt={leader.name} />
                  </Media>
                  <Media body className="ml-5 col-12 col-md-10 mx-auto mt-3 mt-md-0">
            ...
            <div className="row row-content">
                <div className="col-12 col-md-6">
                    ...
                    <p>Started in 2010, Ristorante con Fusion quickly established itself as a culinary icon par excellence in Hong Kong. 
                        ...
                        the A-list clientele in Hong Kong.  Featuring four of the best three-star Michelin chefs in the world, 
